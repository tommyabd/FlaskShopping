...
/**
 * Configure the applyfor element
 * Filters: Trim
 * Validators: Required
 */
$applyfor = new Quform_Element('applyfor', 'Apply For');
$applyfor->addFilter('trim');
$applyfor->addValidator('required');
$form->addElement($applyfor);
